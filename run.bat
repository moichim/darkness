...
start "" "C:\Program Files\SuperCollider-3.13.0\sclang.exe" "%USERPROFILE%\Documents\GitHub\darkness\sound.scd"
...
processing-java --sketch="%USERPROFILE%\Documents\GitHub\darkness" --run